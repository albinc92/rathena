...
UPDATE `item_db2` SET `script` = `script` + "bonus2 bAddClass,Class_All,17;" WHERE  `weapon_level` = 2;
UPDATE `item_db2` SET `script` = `script` + "bonus2 bAddClass,Class_All,33;" WHERE  `weapon_level` = 3;
UPDATE `item_db2` SET `script` = `script` + "bonus2 bAddClass,Class_All,50;" WHERE  `weapon_level` = 4;
